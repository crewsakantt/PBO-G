public class TestAuction {
    public static void main(String[] args) {
        ...
        auction.enterLot("Anthony Gasing");
        auction.enterLot("Mudryk Rudal Ukraina");
        auction.enterLot("Nunez Marmut Uruguay");
        ...
        Person person1 = new Person("Bobby Endrick");
        Person person2 = new Person("Onana lemmein");
